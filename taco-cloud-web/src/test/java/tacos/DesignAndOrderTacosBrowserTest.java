...
public class DesignAndOrderTacosBrowserTest {
    ...
    private void clickBuildAnotherTaco() {
        Assertions.assertTrue(browser.getCurrentUrl().startsWith(ORDERS_URL));
    ...
    private void submitEmptyOrderForm() {
        ...
        Assertions.assertTrue(validationErrors.contains("Please correct the problems below and resubmit."));
        Assertions.assertTrue(validationErrors.contains("Name is required"));
        Assertions.assertTrue(validationErrors.contains("Street is required"));
        Assertions.assertTrue(validationErrors.contains("City is required"));
        Assertions.assertTrue(validationErrors.contains("State is required"));
        Assertions.assertTrue(validationErrors.contains("Zip code is required"));
        Assertions.assertTrue(validationErrors.contains("Not a valid credit card number"));
        Assertions.assertTrue(validationErrors.contains("Must be formatted MM/YY"));
        Assertions.assertTrue(validationErrors.contains("Invalid CVV"));
    }

    private void submitInvalidOrderForm() {
        Assertions.assertTrue(browser.getCurrentUrl().startsWith(ORDERS_CURRENT_URL));
